...
export default function LeadForm() {
  ...
  const { data: existing } = trpc.leads.get.useQuery(
    { id: leadId! },
    { enabled: isEdit }
  );
    ...
    if (existing) {
      setForm({
        ...
        estimatedValue: existing.estimatedValue
          ? String(existing.estimatedValue)
          : "",
        ...
        nextFollowUpAt: existing.nextFollowUpAt
          ? new Date(existing.nextFollowUpAt).toISOString().slice(0, 10)
          : "",
      ...
      <div className="space-y-4 max-w-3xl">
        <div className="flex items-center gap-2">
          <Button
            variant="ghost"
            size="sm"
            onClick={() => setLocation(isEdit ? `/leads/${leadId}` : "/leads")}
            ...
            <CardContent className="space-y-3">
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  value={form.source}
                  onChange={set("source")}
                  placeholder="manual, referral, event..."
                />
              </div>
              <div className="space-y-1.5">
              ...
              <div className="space-y-1.5">
                ...
                <Select
                  ...
                  onValueChange={v =>
                    setForm(f => ({ ...f, assignedTo: v === "none" ? "" : v }))
                  }
                >
                  <SelectTrigger>
          ...
          <Card className="border shadow-sm">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="space-y-1.5">
                ...
                <Textarea
                  value={form.futureOpportunities}
                  onChange={set("futureOpportunities")}
                  placeholder="What could we offer?"
                  rows={2}
                />
              </div>
              <div className="space-y-1.5">
                ...
                <Textarea
                  ...
                  placeholder="How would we monetize?"
                  rows={2}
                />
              </div>
            </CardContent>
